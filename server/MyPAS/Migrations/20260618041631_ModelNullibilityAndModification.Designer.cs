...
namespace MyPAS.Migrations
{
    ...
    [Migration("20260618041631_ModelNullibilityAndModification")]
    partial class ModelNullibilityAndModification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPAS.Models.MyPASUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MyPAS.Models.Procedure", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyPAS.Models.MyPASUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyPAS.Models.Payment", b =>
                {
                    ...
                    b.HasOne("MyPAS.Models.Procedure", "Procedure")
                        .WithMany("Payments")
